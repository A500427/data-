...
# ------------------- Pagina 2 --------------------------
    ...
    maand_aantal = maand_aantal.sort_index()
    ...
    # ✅ Slimme labeling: toon slechts elke N-de maand
    n = max(1, len(cumulatief) // 12)  # toon ongeveer 12 labels per jaar
    tickvals = cumulatief.index[::n]
